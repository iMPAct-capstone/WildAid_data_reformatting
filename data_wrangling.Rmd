...
Ok now that we have tested things out with googlesheet4 let's make a final spreadsheet where all the data is going to live and be pulled from for our Shiny apps 
