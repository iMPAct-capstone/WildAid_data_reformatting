...
collaboration_split <- data_reformat |> 
  filter(str_detect(sub_category, "Collaboration")) |> filter(category == "Surveillance and Enforcement" ) #find the collaboration row or rows 
...
```{r}
site_list <- read_excel(file.path(data_path, "tables", "site_list_lookup_table.xlsx")) #read list of reformatted site names 
